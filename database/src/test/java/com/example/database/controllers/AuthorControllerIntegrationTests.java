...
public class AuthorControllerIntegrationTests {
    ...
    public void testThatCreateAuthorSuccessfullyReturnsSavedAuthor() throws Exception {
        ...
        mockMvc.perform(
                ...
                MockMvcResultMatchers.jsonPath("$.name").value("Mircea Bravo")
        ).andExpect(
                MockMvcResultMatchers.jsonPath("$.age").value(55)
        );
    }
    ...
    public void testThatListAuthorsReturnsListOfAuthors() throws Exception {
        ...
        mockMvc.perform(
                ...
                MockMvcResultMatchers.jsonPath("$[0].name").value("Mircea Bravo")
        ).andExpect(
                MockMvcResultMatchers.jsonPath("$[0].age").value(55)
        );
    }
    ...
    public void testThatFullUpdateUpdatesExistingAuthor() throws Exception {
        ...
        String testAuthorUpdateJson = objectMapper.writeValueAsString(testAuthorEntityB);
